...
export const useHome = () => {
    ...
    const loadDetailsWalletTokens = async () => {
    ...
    const {
        ...
        nameDetails: 'Balance',
        loadDetails: loadDetailsWalletTokens, // Fetches details using the loadDetails function
    ...
    const {
        ...
        loadList: loadListOTCTokens, // The function to load the list of MarketNFTs with metadata
    });
    //--------------------------------------
    // Sync the market data with the blockchain
    const handleBtnSync = async () => {
        console.log('Syncing OTC Tokens data with the blockchain...');
